...
df=pd.read_csv("latest_version_cars.csv")
...
Fuel_Consumption = st.sidebar.number_input("Numeric value of nosumption.", min_value=0)
Age = st.sidebar.number_input("Age of the car.", min_value=0)
Fiat = st.sidebar.number_input("Input 1 if car is Fiat else Keep it as 0.", min_value=0)
Ford = st.sidebar.number_input("Input 1 if car is Ford else Keep it as 0.", min_value=0)
Renault = st.sidebar.number_input("Input 1 if car is Renault else Keep it as 0.", min_value=0)
Toyota = st.sidebar.number_input("Input 1 if car is Toyota else Keep it as 0.", min_value=0)
Volkswagen = st.sidebar.number_input("Input 1 if car is VW else Keep it as 0.", min_value=0)
Manuel = st.sidebar.number_input("Input 1 if car is Manuel Gear else Keep it as 0", min_value=0)
Automatic = st.sidebar.number_input("Input 1 if car is Automatic Gear else Keep it as 0", min_value=0)
Semi_Automatic = st.sidebar.number_input("Input 1 if car is Semi-Auto Gear else Keep it as 0", min_value=0)
Benzin = st.sidebar.number_input("Input 1 if car fuel is Benzin else Keep it as 0.", min_value=0)
Diesel = st.sidebar.number_input("Input 1 if car fuel is Diesel else Keep it as 0.", min_value=0)
Hybrid = st.sidebar.number_input("Input 1 if car fuel is Hybrid else Keep it as 0 .", min_value=0)
Benzin_LPG = st.sidebar.number_input("Input 1 if car fuel is Benzin&LPG else Keep it as 0.", min_value=0)
